...
from object_recognition_ros.ecto_cells.io_ros import Publisher_Marker
import ecto
...
class Publisher(ecto.BlackBox, SinkBase):
    ...
    def declare_direct_params(p):
        ...
        p.declare('recognized_object_array_topic', 'The ROS topic to use for the recognized object', 'recognized_object_array_') #MSD debug
