...
from object_recognition_msd_pcl.ecto_cells.ecto_msd_pcl_exp import Detector_experimental as Detector
...
class MsdPclDetectorExp(ecto.BlackBox, DetectorBase):
