...
from object_recognition_msd_pcl.ecto_cells.ecto_msd_pcl_exp import VFH_Trainer_experimental


def create_capture_plasm(object_id, angle_thresh, segmentation_cell, n_desired,
...
#   Compute vfh
    ...
    trainer_ = VFH_Trainer_experimental(json_db_in = _json_db, object_id_in = object_id)
    ...
    graph += [ pose_filter['R', 'T'] >> rt2pose_filtered['R', 'T'],
